...
<body>
    ...
    <div>
        <asp:TextBox ID="HeatNoFilter" Visible="false" runat="server" BorderStyle="None"></asp:TextBox>
    ...
    <asp:textbox ID="CompetitionName" runat="server" Height="55px" Width="1000px" Font-Bold="True" Font-Size="X-Large" BorderStyle="None" style="text-align: center" ReadOnly="true"></asp:textbox>
        ...
        <br />
        <br />
        <asp:TextBox ID="CompetitionEventName" runat="server" Font-Size="Larger" Font-Bold="True" Font-Italic="True" Width="700px" BorderStyle="None" ReadOnly="True"></asp:TextBox>
        <asp:TextBox ID="DateAndTime" runat="server"  Width="250px" BorderStyle="None" ReadOnly="True" style="text-align: right"></asp:TextBox>
        <br />
        <br />
