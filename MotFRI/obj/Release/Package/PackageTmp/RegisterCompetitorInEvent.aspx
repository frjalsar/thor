...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:TextBox ID="CompetitionName" runat="server" Font-Size="X-Large" ReadOnly="True" Width="1035px"  ></asp:TextBox>
    <br />
 ...
 <asp:TextBox ID="BibNo" runat="server" ReadOnly="true" Width="79px"></asp:TextBox>&nbsp;&nbsp;
    ...
    <asp:GridView ID="AvailableEvents" runat="server" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="AvailableEventsForCompetitor" ForeColor="#333333" GridLines="None">
    ...
    <br />
    <asp:Button ID="RegEventsForComp" runat="server" Text="Skrá í valdar greinar" OnClick="RegEventsForComp_Click" />
